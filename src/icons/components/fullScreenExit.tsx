...
const FullScreenExitIcon: React.FC<IconProps> = ({ size = IconSize.lg, ...props }) => {
  ...
  return <BaseIcon size={size} testId="FullScreenExit" graphic={graphic} viewBox="0 -960 960 960" />;
};
